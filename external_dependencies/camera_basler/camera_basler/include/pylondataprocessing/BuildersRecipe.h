        ...
        public:
            ...
            */
            ...
            /*!
             ...
             \param[in] inputTypeID Type ID of the new input.
             ...
             \pre
                ...
                - \c inputTypeID refers to an existing type.
                - The recipe hasn't been started (i.e., IsStarted() must return false).

             \post
                - An input with the type identified by \c inputTypeID has been added to the recipe with the identifier \c inputFullName.
             ...
             \threading
                This method is synchronized using the lock provided by \c GetLock().
            */
            virtual void AddInput(const Pylon::String_t& inputFullName, const Pylon::String_t& inputTypeID);
            ...
            /*!
             ...
             See AddInput(const Pylon::String_t&, const Pylon::String_t&) for a list of valid type IDs.
             ...
             \post
                - An input with the type identified by \c inputTypeID has been added to the recipe.
             ...
             \threading
                This method is synchronized using the lock provided by \c GetLock().
            */
            virtual Pylon::String_t AddInput(const Pylon::String_t& inputTypeID);
            ...
            */
            ...
            /*!
             ...
             \param[in] outputTypeID Type ID of the new output.
             ...
             \pre
                ...
                - \c outputTypeID refers to an existing type.
                - The recipe hasn't been started (i.e., IsStarted() must return false).

             \post
                - An output with the type identified by \c outputTypeID has been added to the recipe with the identifier \c outputFullName.
             ...
             \threading
                This method is synchronized using the lock provided by \c GetLock().
            */
            virtual void AddOutput(const Pylon::String_t& outputFullName, const Pylon::String_t& outputTypeID);
            ...
            /*!
             ...
             \post
                - An output with the type identified by \c outputTypeID has been added to the recipe.
             ...
             \threading
                This method is synchronized using the lock provided by \c GetLock().
            */
            virtual Pylon::String_t AddOutput(const Pylon::String_t& outputTypeID);
