...
namespace Pylon
{
    namespace DataProcessing
    {
        /*!
         ...
         \threading
            The \c CVariantContainer class is not thread-safe.
        */
            ...
            */
            ...
            /*!
             ...
             \error
                Doesn't throw C++ exceptions.
            */
            virtual iterator find(const String_t& key) const;
            ...
            /*!
             ...
             \error
                Doesn't throw C++ exceptions.
            */
            virtual size_t count(const String_t& key) const;
            ...
            */
            ...
            /*!
             ...
             \error
                Doesn't throw C++ exceptions.
            */
            virtual CVariantContainer::iterator erase(const CVariantContainer::iterator& it);
            ...
            /*!
             ...
             \error
                Doesn't throw C++ exceptions.
            */
            virtual size_t erase(const String_t& key);
